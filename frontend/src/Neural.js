...
//import U from "../Utilities/utilities_lib.js" ;
//import FS from "fs";
...
*/  
     trainX = U.loadTxt(".\\Data\\train.txt", "\t",
    [0]);
    let trainY = U.loadTxt(".\\Data\\train.txt", "\t",
    [1]);
    /* trainX = U.loadTxt(".\\Data\\train2.txt", "\t",
    [0]);
    let trainY = U.loadTxt(".\\Data\\train2.txt", "\t",
    [1]);*/
    /* trainX = U.loadTxt(".\\Data\\train3.txt", "\t",
    [0]);
    let trainY = U.loadTxt(".\\Data\\train3.txt", "\t",
    [1]);*/
    /*let trainX = U.loadTxt(".\\Data\\train4.txt", "\t",
    [0]);
    let trainY = U.loadTxt(".\\Data\\train4.txt", "\t",
    [1]);*/
    let testX = [9]
    let testY = [0.1208208]
    U.matShow(trainX,6);
  ...
  // 2. create network
  console.log("\nCreating a 1-100-1 tanh, Identity NN");
  let seed = 0;
  ...
  //let testAcc = nn.accuracy(testX, testY, 1.00);
