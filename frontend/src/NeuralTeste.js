...
function main()
{
  ...
  /*let predValores = [];
  for (let i = 17; i < 32; ++i) {
    let unknownNorm = [i];// Mudar esse valor para cada dia previsto. 9 eh o dia 22/03, 10 é o dia 23/03 e assim em diante 
  ...
  //let unknownNorm = [16];// Mudar esse valor para cada dia previsto. 9 eh o dia 22/03, 10 é o dia 23/03 e assim em diante 
  //let predicted = nn.eval(unknownNorm);
  //console.log("\ndia:");
